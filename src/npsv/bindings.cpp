...
PYBIND11_MODULE(npsva, m) {
  ...
  py::class_<npsv::RealignedFragments>(m, "RealignedFragments")
      .def(py::init<double, double, const npsv::InsertSizeDistribution::density_type&, const std::string&>())
      ...
      .def("count_baseline_straddlers", &npsv::RealignedFragments::CountBaselineStraddlers);
